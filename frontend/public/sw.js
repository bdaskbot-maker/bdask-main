// ============================================
// BdAsk Service Worker
// Enables offline support for Bangladesh's unreliable networks
// ============================================

const CACHE_NAME = 'bdask-v1';
const STATIC_CACHE = 'bdask-static-v1';
const API_CACHE = 'bdask-api-v1';
...
self.addEventListener('install', (event) => {
  console.log('[SW] Installing BdAsk Service Worker...');
  event.waitUntil(
